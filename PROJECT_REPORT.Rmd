...
An interactive web application has been developed using R Shiny to allow users to explore model predictions with custom patient inputs. The application provides real-time predictions from all three models (Logistic Regression, CART, and Random Forest), along with visualizations and model comparison metrics. Access the interactive dashboard at: \url{https://petermangoro.shinyapps.io/hospitalreadmission/}
